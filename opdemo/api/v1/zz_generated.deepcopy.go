...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebServiceWebappSpec) DeepCopyInto(out *WebServiceWebappSpec) {
	*out = *in
	if in.Size != nil {
		in, out := &in.Size, &out.Size
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebServiceWebappSpec.
func (in *WebServiceWebappSpec) DeepCopy() *WebServiceWebappSpec {
	if in == nil {
		return nil
	}
	out := new(WebServiceWebappSpec)
